...
def map():
      ...
      if request.method == "POST": 
          ...
          return render_template('display.html',lang=longitude,lat=latitude,Country=Country,data=data,postweetslen=len(Positive_tweets),negtweetslen=len(Negative_tweets),words=dict_of_words,freq=dict_of_frequency,ERROR_MSG="Found")
      else:
